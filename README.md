...
- [**🕹️ Feature**](#️-feature)
    - [데이터베이스 열람](#데이터베이스-열람)
    - [데이터베이스 생성/삭제](#데이터베이스-생성삭제)
    - [도큐먼트 생성/삭제](#도큐먼트-생성삭제)
    - [도큐먼트 수정](#도큐먼트-수정)
    - [디테일뷰 GUI 커스터마이즈](#디테일뷰-gui-커스터마이즈)
    - [관계설정](#관계설정)
- [**🔗 Links**](#-links)
    - [Deployed link](#deployed-link)
    - [Github Repositories](#github-repositories)
- [**🏔 Challenges**](#-challenges)
  - [1. 비전문가를 배려한 직관적인 데이터베이스툴 구현](#1-비전문가를-배려한-직관적인-데이터베이스툴-구현)
    - [1-1. 각 타입에 어울리는 태그를 다르게 적용하기](#1-1-각-타입에-어울리는-태그를-다르게-적용하기)
  ...
  - [2. 어떻게 데이터베이스의 관계설정을 구현할 수 있을까?](#2-어떻게-데이터베이스의-관계설정을-구현할-수-있을까)
    ...
    - [2-2. MongoDB로 데이터베이스 간 관계 설정 기능을 어떻게 구현할까?](#2-2-mongodb로-데이터베이스-간-관계-설정-기능을-어떻게-구현할까)
      - [관계형 DB의 Primary Key, Foreign Key 개념을 응용](#관계형-db의-primary-key-foreign-key-개념을-응용)
